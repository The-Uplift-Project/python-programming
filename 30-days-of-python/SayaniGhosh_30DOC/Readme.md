...
##### <i class="icon-file"></i> Vigenere Autokey Cipher Encrypt
	In this algorithm we decrypt a given message with "Vigenere Autokey Cipher Method" using Python.

##### <i class="icon-file"></i> Vigenere Autokey Cipher Decrypt
	In this algorithm we decrypt a given message with "Vigenere Autokey Cipher Method" using Python.
